...
namespace MQTTnet.Client
{
    public class MqttClient : IMqttClient
    {
        ...
        {
            _packetReceiverTask = Task.Factory.StartNew(() => ReceivePacketsAsync(cancellationToken),
                cancellationToken,
        ...
        {
            _keepAliveMessageSenderTask = Task.Factory.StartNew(() => SendKeepAliveMessagesAsync(cancellationToken),
                cancellationToken,
                TaskCreationOptions.LongRunning,
                TaskScheduler.Current);
        }

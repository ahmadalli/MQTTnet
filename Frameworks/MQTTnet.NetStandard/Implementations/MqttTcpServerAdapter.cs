    ...
    public class MqttTcpServerAdapter : IMqttServerAdapter
    {
        ...
        public Task StartAsync(IMqttServerOptions options)
        {
            ...
            if (options.DefaultEndpointOptions.IsEnabled)
            {
                ...
                Task.Factory.StartNew(() => AcceptDefaultEndpointConnectionsAsync(_cancellationTokenSource.Token),
            ...
            if (options.TlsEndpointOptions.IsEnabled)
            {
                ...
                Task.Factory.StartNew(() => AcceptTlsEndpointConnectionsAsync(_cancellationTokenSource.Token),
                    _cancellationTokenSource.Token,
                    TaskCreationOptions.LongRunning,
                    TaskScheduler.Current);
            }
